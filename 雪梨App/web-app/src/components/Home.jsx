    ...
    <div className="pb-20">
      ...
      <div className="p-4">
        <div className="bg-gradient-to-r from-sherry-400 to-sherry-600 rounded-2xl p-6 text-white shadow-lg shadow-sherry-200">
          ...
          <p className="opacity-90">开启你的跨次元对话之旅</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 px-4">
        {novels.map(novel => (
          <div 
            ...
            className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow cursor-pointer flex md:flex-col"
          >
            <div className="w-24 h-32 md:w-full md:h-48 flex-shrink-0">
              <img src={novel.cover} alt={novel.title} className="w-full h-full object-cover" />
            </div>
            <div className="p-3 flex-1 flex flex-col justify-between">
              <div>
                <h4 className="font-bold text-gray-900 line-clamp-1">{novel.title}</h4>
